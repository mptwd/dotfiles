...
#if [ -f /home/marc/.config/synth-shell/synth-shell-prompt.sh ] && [ -n "$( echo $- | grep i )" ]; then
#	source /home/marc/.config/synth-shell/synth-shell-prompt.sh
#fi
...
export TA_LIBRARY_PATH=$/home/marc/talib/ta-lib/lib
